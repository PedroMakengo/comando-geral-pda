...
// ── Componente ────────────────────────────────────────────────
export default function AutoAvaliacaoChefePage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        console.error('[AUTO_AVALIACAO_CHEFE]', e)
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-md border border-amber-200 bg-amber-50 p-8 text-center">
          ...
          <p className="text-xs text-amber-600 mt-1">
            O administrador ainda não criou a sua ficha para{' '}
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-md border border-emerald-200 bg-emerald-50 p-8 text-center">
          ...
          <p className="text-sm text-emerald-600 mt-1">
            Registada com sucesso. Aguarde a validação do Director.
          </p>
